...
public class AIConfigDialog extends JDialog {
    ...
    private void setupUI(){
        ...
        goalTextArea.setText("Example: I want to learn Python programming over the next week. I have 2 hours available each weekday evening and 4 hours on weekends. (Delete this example and replace it with your own)");
