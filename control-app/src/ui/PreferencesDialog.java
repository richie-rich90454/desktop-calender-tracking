...
public class PreferencesDialog extends JDialog {
    ...
    private JPanel createGeneralPanel(){
        ...
        timeFormatCombo.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        panel.add(timeFormatCombo, gbc);
        gbc.gridx=0;
        gbc.gridy=2;
        gbc.weightx=0;
        JLabel defaultViewLabel=new JLabel("Default view:");
        defaultViewLabel.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        ...
        defaultViewCombo.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        ...
        showWeekNumbers.setFont(new Font("Segoe UI", Font.PLAIN, 13));
    ...
    private JPanel createCalendarPanel(){
        ...
        workHoursLabel.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        ...
        workHoursCombo.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        panel.add(workHoursCombo, gbc);
        gbc.gridx=0;
        gbc.gridy=1;
        gbc.weightx=0;
        JLabel defaultDurationLabel=new JLabel("Default event duration:");
        defaultDurationLabel.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        ...
        showHolidays.setFont(new Font("Segoe UI", Font.PLAIN, 13));
        ...
        allowOverlap.setFont(new Font("Segoe UI", Font.PLAIN, 13));
