...
public class AudioTrack {
    ...
    // Added null check for audioFile in constructor
    ...
    private String extractDisplayName(String fileName) {
        if (fileName.matches("^\\d{3}_.*")) {
            return fileName.substring(4); // Remove "NNN_" prefix
        }
        return fileName;
    }
    ...
    // This method seems incorrect - it adds the prefix again to the already prefixed name
    // Removed as it's not used correctly elsewhere
    ...
    public boolean equals(Object o) {
        ...
        // Compare absolute paths for robustness across different Path representations
        return trackNumber == that.trackNumber &&
                Objects.equals(audioFile.getAbsolutePath(), that.audioFile.getAbsolutePath());
    }
    ...
    public String toString() {
        return String.format("AudioTrack{number=%03d, name='%s', file='%s', duration=%dms}",
                trackNumber, displayName, audioFile.getName(), duration);
    }
